...
function Journey() {
  return (
    <section className="container-base py-16 sm:py-24">
      <div data-reveal className="reveal">
        <h2 className="section-title">Como funciona sua jornada na Benevere</h2>
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-2">
        {steps.map((step) => (
          <article key={step.number} data-reveal className="reveal premium-card p-6">
